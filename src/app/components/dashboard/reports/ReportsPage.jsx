    ...
    if (!isGenerated && !isProcessing) {
        return (
            <div className="min-h-screen bg-gray-50">
                ...
                {/* Hero Section */}
                <section className={`mx-6 my-6 ${isMobileView ? 'flex-col space-y-6 p-6' : 'flex justify-between items-center p-12'} rounded-2xl bg-gradient-to-r from-[#1A2B6C] to-[#1e5ea5] text-white relative overflow-hidden shadow-xl`}>
